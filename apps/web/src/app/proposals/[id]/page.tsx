...
import {
  getPersistedProposalDraftUseCase,
...
function BudgetSummary({
  ...
  if (
    ...
    return (
      <p className="text-sm text-zinc-600">
        No customer budget was captured.
      </p>
    );
  }
  ...
  if (difference > 0) {
    return (
      <p
        data-testid="proposal-budget-status"
...
export default async function ProposalDraftPage({
  ...
  const draft =
    await getPersistedProposalDraftUseCase(
      parsedId.data,
    );
  ...
  return (
    <main
      ...
      className="min-h-screen bg-zinc-50 px-6 py-16"
    >
        ...
        <div className="mt-10 space-y-6">
          <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8">
            ...
            <p className="mt-5 text-xs leading-5 text-zinc-500">
              Source inquiry{" "}
              <span
                data-testid="proposal-inquiry-id"
          ...
          <section className="rounded-2xl border border-emerald-200 bg-emerald-50 p-5 sm:p-6">
            ...
            <p className="mt-2 text-sm leading-6 text-emerald-800">
              AI interpretation is upstream.
              Human review resolves uncertain
              facts. Deterministic domain code
              owns quantities and totals.
              This persisted draft stores that
              result as a historical snapshot.
            </p>
          </section>
        </div>
      </div>
