...
describe(
  ...
  () => {
    ...
    it(
      "rejects unknown product search fields",
      () => {
        expect(
          mcpSearchProductsInputSchema.safeParse({
            query:
    ...
    it(
      "rejects caller-supplied pricing fields",
      () => {
        const input = {
          inquiryId,
          selections: [
        ...
        expect(
          mcpCalculatePricingInputSchema.safeParse(
            input,
          ).success,
        ).toBe(false);
    ...
    it(
      "accepts a proposal identifier for validation",
      () => {
        expect(
    ...
    it(
      "rejects approval claims on create_draft",
      () => {
        expect(
          mcpCreateDraftInputSchema.safeParse({
            inquiryId,
