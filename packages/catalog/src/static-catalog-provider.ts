import type { CatalogProvider, PricingCatalog } from "@proposal-agent/application";
import type { CatalogItem } from "@proposal-agent/domain";

export const DEMO_CATALOG_VERSION = "2026-08-demo-v1";

const demoCatalogItems: readonly CatalogItem[] = Object.freeze([
  Object.freeze({
    id: "hotel_room_night",
    name: "Hotel room",
    currency: "SEK",
...
const demoCatalog: PricingCatalog = Object.freeze({
