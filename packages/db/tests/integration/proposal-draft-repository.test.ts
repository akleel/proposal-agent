...
const inquiryRepository =
  new PostgresInquiryRepository(
    pool,
  );

const proposalDraftRepository =
...
describe(
  ...
  () => {
    it(
      "persists and loads the complete proposal draft snapshot",
      async () => {
        await inquiryRepository.create({
          id:
            inquiryId,
          rawText:
            "20 people, 10 rooms, 2026-10-14 to 2026-10-16.",
          createdAt:
            new Date(
    ...
    it(
      "keeps historical pricing independent of later catalog changes",
      async () => {
        await inquiryRepository.create({
          id:
            inquiryId,
          rawText:
            "Historical proposal snapshot test.",
          createdAt:
            new Date(
              "2026-08-27T12:00:00.000Z",
            ),
    ...
    it(
      "returns null for an unknown proposal draft",
      async () => {
        const result =
          await proposalDraftRepository
            .findById(
