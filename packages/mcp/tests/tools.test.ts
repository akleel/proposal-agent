...
describe(
  "Proposal MCP core tools",
  () => {
    it(
      "search_products exposes configured authoritative products",
      async () => {
        const {
          dependencies,
        } =
    ...
    it(
      "calculate_pricing uses the authoritative catalog price",
      async () => {
        const {
          dependencies,
        } =
    ...
    it(
      "calculate_pricing rejects caller-supplied prices",
      async () => {
        const {
          dependencies,
        } =
    ...
    it(
      "create_draft persists only draft state",
      async () => {
        const {
          dependencies,
          proposals,
    ...
    it(
      "validate_proposal validates the persisted snapshot",
      async () => {
        const {
          dependencies,
        } =
    ...
    it(
      "validate_proposal returns not_found for an unknown draft",
      async () => {
        const {
          dependencies,
        } =
