...
describe(
  "Proposal Agent MCP stdio protocol",
  () => {
    it(
      "negotiates 2026-07-28, exposes four tools, and rejects authority escalation",
      async () => {
        const client =
          new Client(
            {
              name:
                "proposal-agent-protocol-test",
              version:
                "1.0.0",
            },
            {
        ...
        const transport =
          new StdioClientTransport({
            ...
            env: {
              ...getDefaultEnvironment(),
              DATABASE_URL:
                "postgresql://mcp_smoke:mcp_smoke@127.0.0.1:1/mcp_smoke",
            },
          });
