...
export async function searchProductsTool(
  ...
  const parsed =
    mcpSearchProductsInputSchema.parse(
      input,
    );
...
export async function calculatePricingTool(
  ...
  const parsed =
    mcpCalculatePricingInputSchema.parse(
      input,
    );
...
export async function validateProposalTool(
  ...
  const parsed =
    mcpValidateProposalInputSchema.parse(
      input,
    );
  ...
  const result =
    await validateProposalDraft(
      {
        proposalDraftRepository:
          dependencies.proposalDraftRepository,
      },
  ...
  return {
    status:
      "valid_snapshot" as const,
    proposalDraftId:
      result.draft.id,
    proposalStatus:
      result.draft.status,
    inquiryId:
      result.draft.inquiryId,
    catalogVersion:
...
export async function createDraftTool(
  ...
  const parsed =
    mcpCreateDraftInputSchema.parse(
      input,
    );
